            ...
            <div :class="wrapperClass">
              ...
              <section v-if="page.layout === 'hero'" class="mb-10">
                <div class="relative rounded-3xl overflow-hidden border border-slate-800">
                  <img v-if="page.featured_image" :src="page.featured_image" :alt="page.title"
              ...
              <header v-else :class="`mb-8 p-6 rounded-2xl border ${theme.headerBg}`">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <button v-if="$page.props.canCopyUrl" type="button" @click="copyUrl"
  ...
  <AdSense />
              ...
              <div v-if="page.layout === 'magazine'" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <main class="lg:col-span-8">
                  <ContentBlocks :blocks="page.blocks" :content="page.content" :cardClass="theme.card"
    ...
    <footer class="mt-16 pt-10">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-4">
          ...
          <div class="space-y-3">
            <!-- privremeno -->
            <Link v-for="p in related.slice(0, 4)" :key="p.id" :href="pageHref(p)"
              ...
              <div class="min-w-0">
                ...
                <div
                  class="text-sm font-semibold truncate text-slate-900 group-hover:text-slate-950 dark:text-slate-100 dark:group-hover:text-white">
                  {{ p.title }}
                </div>
                <div class="mt-1">
        ...
        <div class="lg:col-span-4">
          ...
          <div class="space-y-3">
            <Link v-for="p in latest.slice(0, 4)" :key="p.id" :href="pageHref(p)"
              class="group flex gap-3 rounded-xl border border-slate-800 bg-slate-950/40 hover:bg-slate-900/40 transition-colors p-3">
        ...
        <div class="lg:col-span-4">
          ...
          <div class="space-y-3">
            <Link v-for="p in popular" :key="p.id" :href="pageHref(p)"
              class="group flex gap-3 rounded-xl border border-slate-800 bg-slate-950/40 hover:bg-slate-900/40 transition-colors p-3">
              <div class="w-20 h-14 rounded-lg overflow-hidden shrink-0 border border-slate-800">
                <img v-if="getThumb(p)" :src="getThumb(p)" :alt="p.title" class="w-full h-14 object-cover" />

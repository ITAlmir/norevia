  ...
  <MainLayout>
    <div class="max-w-5xl mx-auto px-4 py-8">
      <div class="mb-8">
        ...
        <p class="text-gray-400 mt-2">Create a new content page or blog post</p>
        <p class="text-gray-500 text-sm mt-2">
          Layout affects the public page styling, spacing, typography and content presentation.
        </p>
      </div>
      ...
      <div class="bg-slate-800/50 rounded-2xl border border-slate-700 p-6">
        <form @submit.prevent="submitForm">
          ...
          <!-- Kind -->
          <div class="mb-6">
            <label class="block text-gray-300 text-sm font-medium mb-2">Content kind</label>
            <select
              v-model="form.type"
              class="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-gray-300"
            >
          ...
          <!-- Blog topic -->
          <div v-if="form.type === 'blog'" class="mb-6">
          ...
          <div class="mb-6">
            ...
            <input
              ...
              type="text"
              required
              class="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <details class="mb-6">
            ...
            <div class="mt-4">
              ...
              <div v-if="imagePreview" class="mb-4">
                <img :src="imagePreview" alt="Preview" class="max-h-64 rounded-xl" />
              </div>
              ...
              <div class="space-y-4">
                <div class="border-2 border-dashed border-slate-700 rounded-xl p-6 text-center">
                  ...
                  <p class="text-gray-400 mb-2">Upload an image (max 150MB)</p>
                  <input
                    type="file"
                    ref="fileInput"
                ...
                <div class="flex">
                  <input
                    ...
                    class="flex-1 px-4 py-2 bg-slate-900 border border-slate-700 text-gray-300 rounded-l-xl focus:outline-none"
                  />
                  <button
                    type="button"
                    @click="useImageUrl"
                    class="px-4 py-2 bg-slate-700 text-gray-300 hover:bg-slate-600 rounded-r-xl"
                  >
                    Use URL
                  </button>
                </div>
            ...
            <div class="flex items-center justify-between mb-4 flex-wrap gap-3">
              ...
              <div class="flex gap-2 flex-wrap">
                ...
                <button
                  type="button"
                  @click="addCtaBlock"
                  class="px-3 py-2 rounded-lg text-sm font-medium bg-emerald-600/90 hover:bg-emerald-600 text-white shadow-sm hover:shadow-md transition-all duration-200"
                >
                  + CTA
                </button>
              </div>
              ...
              >
                ...
                <div v-if="block.type === 'text'" class="space-y-3">
                  ...
                  <textarea
                    ...
                    rows="8"
                    class="w-full bg-slate-900 border border-slate-700 rounded-xl px-4 py-3 text-gray-300 leading-7"
          ...
          <div class="flex justify-end space-x-4">
            <a
              ...
              class="px-6 py-3 border border-slate-600 text-gray-300 rounded-xl font-medium hover:bg-slate-700"
            >
              Cancel
            </a>
            <button
              type="submit"
              :disabled="loading"
              class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium disabled:opacity-50"
            >
...
const handleBlockImageUpload = async (event, i) => {
  ...
  reader.onload = async (e) => {
    ...
    try {
      ...
      alert('Upload failed, preview remains.')
    } finally {
      event.target.value = ''
    }
  }
...
const hasAnyBlockContent = () => {
  return form.blocks.some(b => {
    ...
    if (b.type === 'ad') {
      if (b.kind === 'adsense') return (b.adsense_slot || '').trim().length > 0
